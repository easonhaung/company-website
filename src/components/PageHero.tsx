...
export function PageHero({
  ...
  return (
    <section className="w-full min-h-[200px] sm:min-h-[220px] bg-slate-100 border-b border-slate-200 relative overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-[1400px] min-w-0 px-4 sm:px-6 lg:px-8 py-12 md:py-16">
