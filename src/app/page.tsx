...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="relative w-full aspect-[16/7] min-h-[50vh] sm:min-h-[60vh] flex items-center justify-center overflow-hidden">
        {/* 背景圖：科技感 */}
        ...
        <div className="relative z-10 w-full max-w-[1400px] min-w-0 px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-left">
              ...
              <p className="hero-desc-2 text-slate-400 max-w-xl text-sm sm:text-base mb-10">
