        ...
        <div className="relative z-10 w-full max-w-[1400px] min-w-0 px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="text-left lg:col-span-1">
              <h1 className="hero-title-animate text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 tracking-tight mb-6" style={{ fontFamily: 'PROJECT9, sans-serif' }}>
                EZeeTech
              </h1>
              <p className="hero-desc-1 text-lg sm:text-xl text-slate-800 max-w-2xl leading-relaxed mb-4">
                專注於車用電池系統之震動電能回收技術，
                提供領先的車用應用驗證與試點解決方案。
              </p>
              <p className="hero-desc-2 text-slate-600 max-w-xl text-sm sm:text-base mb-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Link
                  href="/contact"
                  className="hero-btn-primary w-full sm:w-auto px-6 py-3 bg-slate-900 text-white font-medium rounded-lg hover:bg-slate-800 shadow-lg text-center"
                >
                  聯絡我們
                </Link>
                <Link
                  href="/news"
                  className="hero-btn-secondary w-full sm:w-auto px-6 py-3 bg-white text-slate-900 font-medium rounded-lg border border-slate-300 hover:bg-slate-50 text-center"
                >
                  最新消息
                </Link>
              </div>
